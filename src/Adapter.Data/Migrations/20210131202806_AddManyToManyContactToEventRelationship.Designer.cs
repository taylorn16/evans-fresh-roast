...
namespace Adapter.Data.Migrations
{
    ...
    [Migration("20210131202806_AddManyToManyContactToEventRelationship")]
    partial class AddManyToManyContactToEventRelationship
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CoffeeRoastingEventContact", b =>
                {
                    b.Property<Guid>("CoffeeRoastingEventsId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("ContactsId")
                        .HasColumnType("uniqueidentifier");

                    b.HasKey("CoffeeRoastingEventsId", "ContactsId");

                    b.HasIndex("ContactsId");

                    b.ToTable("CoffeeRoastingEventContact");
                });
            ...
            modelBuilder.Entity("Adapter.Data.Models.Order", b =>
                {
                    ...
                    b.HasOne("Adapter.Data.Models.Contact", "Contact")
                        .WithMany("Orders")
            ...
            modelBuilder.Entity("CoffeeRoastingEventContact", b =>
                {
                    b.HasOne("Adapter.Data.Models.CoffeeRoastingEvent", null)
                        .WithMany()
                        .HasForeignKey("CoffeeRoastingEventsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Adapter.Data.Models.Contact", null)
                        .WithMany()
